module.exports= function Page(opt) {
    ...
    var clickpages = {
        ...
        newPages:function (type, i) {
            ...
            for (var n = 0;n<3;n++){
                htmlC += '<li '+((n-1)==0?'class="active"':'')+' page="'+(i+n-1)+'"><a href="#">'+(i+n-1)+'</a></li>';
                htmlLeft += '<li '+((n+2)==i?'class="active"':'')+' page="'+(n+2)+'"><a href="#">'+(n+2)+'</a></li>';
                htmlRight += '<li '+((set.num+n-3)==i?'class="active"':'')+' page="'+(set.num+n-3)+'"><a href="#">'+(set.num+n-3)+'</a></li>';
            }

            switch (type) {
                case "next":
                    if(i<=4){
                        html+='<li page="1"><a href="#">1</a></li>'+htmlLeft+HL+'<li page="'+set.num+'"><a href="#">'+set.num+'</a></li>';
                    }else if(i>=(set.num-3)){
                        html+='<li page="1"><a href="#">1</a></li>'+HL+htmlRight+'<li page="'+set.num+'"><a href="#">'+set.num+'</a></li>';
                    }else{
                        html += '<li page="1"><a href="#">1</a></li>'+HL+htmlC+HL+'<li page="'+set.num+'"><a href="#">'+set.num+'</a></li>';
                    }
                    break;
                case "prev":
                    if(i<=4){
                    ...
                    break;
                case "«" :
                    html+='<li class="active" page="1"><a href="#">1</a></li>'+htmlLeft+HL+'<li page="'+set.num+'"><a href="#">'+set.num+'</a></li>';
                    break;
                case "»" :
                    html+='<li page="1"><a href="#">1</a></li>'+HL+htmlRight+'<li class="active" page="'+set.num+'"><a href="#">'+set.num+'</a></li>';
                    break;
                case "jump" :
                    if(i<=4){
                        if(i==1){
